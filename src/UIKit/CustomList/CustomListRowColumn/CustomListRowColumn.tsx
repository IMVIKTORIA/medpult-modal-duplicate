...
function CustomListRowColumn(props: ListColumnProps) {
	const { fr, data, isLink, onClick, code, isIcon } = props
	...
	const integrationIcon = code === 'isIntegration' && data?.info ? icons.IntegrationButton : null
	...
	const statusContragentColor =
		code === 'statusContragent' ? getStatusContragentColor(data?.info) : undefined
	...
	const statusTaskIcon = code === 'statusTask' ? getStatusTaskIcon(data?.info) : undefined
